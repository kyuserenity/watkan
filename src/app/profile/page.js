...
export default async function Page() {
  ...
  return (
    <div className="p-6">
      ...
      <div className="mt-4 flex gap-4">
        <button className="flex-1 rounded-lg bg-zinc-100 p-3 duration-100 hover:bg-zinc-100 focus-visible:bg-zinc-100 active:bg-zinc-200 dark:bg-zinc-900 dark:hover:bg-zinc-900 dark:focus-visible:bg-zinc-200 dark:active:bg-zinc-800">
          แก้ไขโปรไฟล์
        </button>
        <button className="flex-1 rounded-lg bg-zinc-100 p-3 duration-100 hover:bg-zinc-100 focus-visible:bg-zinc-100 active:bg-zinc-200 dark:bg-zinc-900 dark:hover:bg-zinc-900 dark:focus-visible:bg-zinc-200 dark:active:bg-zinc-800">
          แชร์โปรไฟล์
        ...
        <form action={handleLogout}>
          <button
            type="submit"
            className="rounded-lg bg-zinc-100 p-3 duration-100 hover:bg-zinc-100 focus-visible:bg-zinc-100 active:bg-zinc-200 dark:bg-zinc-900 dark:hover:bg-zinc-900 dark:focus-visible:bg-zinc-200 dark:active:bg-zinc-800"
          >
            <LogOutIcon />
          </button>
        </form>
